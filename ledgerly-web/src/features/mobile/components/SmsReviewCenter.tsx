      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-border pb-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Android SMS auto-capture buffer. Transactions are held here for your review before being
        ...
        <Badge
          variant="outline"
          className="bg-primary/10 text-primary border-primary/20 text-xs font-semibold self-start sm:self-auto"
        >
        ...
        <Card className="border-2 border-dashed border-border p-8 text-center bg-card space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground max-w-sm mx-auto mt-1">
              No unreviewed SMS transactions. Test our SMS parser below to simulate incoming bank
              messages.
            </p>
          </div>
        </Card>
