...
- **Issue**: `CapabilityGuard` displayed a generic "Feature Not Active" card without explaining *why* it was excluded or offering a seamless option to switch workspace personas or enable optional capabilities.
